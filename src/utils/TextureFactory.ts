...
export const createTileset = (scene: Phaser.Scene) => {
...
export const createCharacterTextures = (scene: Phaser.Scene) => {
  if (scene.textures.exists("hero_idle")) return;
  const basePalette = {
    X: "#1b2947",
    B: "#3a5ba0",
    S: "#e8f1ff",
  ...
  makePixelSprite(
    scene,
    "item_blade",
    ["...LL...", "..LLLL..", "..LLL...", ".LLLLLL.", "LLLLLLLL", ".LLLLLL.", "..LLL...", "...LL..."],
    {
      L: "#b7f4ff",
      ".": "."
    },
...
export const createEnvironmentalTextures = (scene: Phaser.Scene) => {
  if (scene.textures.exists("ancient_tree")) return;
  makePixelSprite(
    scene,
    "ancient_tree",
    [
