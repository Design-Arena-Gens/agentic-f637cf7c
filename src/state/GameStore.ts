...
export type ItemId = "lunar_blade" | "forest_root" | "cavern_gem" | "ancient_relic";
...
interface GameState {
  ...
  setQuestStageComplete: (questId: string, stageId: string) => void;
...
export const useGameStore = create<GameState>((set, get) => ({
  ...
  setQuestStageComplete: (questId, stageId) =>
    set((state) => {
